...
describe("dashboard management UI wiring", () => {
  ...
  it("exposes Mollie onboarding in business language from the billing workbench", () => {
    ...
    expect(workbench).toContain("Mollie koppelen");
    expect(workbench).toContain("Opnieuw koppelen");
    expect(workbench).toContain("Ontkoppelen");
    expect(workbench).toContain("Mandaten controleren");
    expect(workbench).toContain("Verbonden met Mollie");
    expect(workbench).toContain("Betaalroutes");
    ...
    expect(workbench).toContain("Gegevens voor leden");
    ...
    expect(workbench).not.toContain("Betaalinstellingen bewaren");
  });
